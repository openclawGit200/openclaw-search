...
async function onRequest({ request, env }) {
  ...
  if (engine === "zhipu") {
    ...
    try {
      const resp2 = await fetch("https://open.bigmodel.cn/api/paas/v4/web_search", {
        method: "POST",
        headers: {
...
// ../.wrangler/tmp/pages-hZx3y9/functionsRoutes-0.47400483357878076.mjs
var routes = [
  {
    routePath: "/search/:route",
    mountPath: "/search",
    method: "",
    middlewares: [],
    modules: [onRequest]
